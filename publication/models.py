...
class PublicationsImages(models.Model):
...
class Comments(models.Model):
    ...
    publication = models.ForeignKey('publication.Publications', models.CASCADE, 'post_comments')
...
class Likes(models.Model):
    publication = models.ForeignKey('publication.Publications', models.CASCADE, 'post_likes')
